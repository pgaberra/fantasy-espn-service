...
public class EspnPlayerClient {
    ...
    private static FetchedPlayer toPlayer(JsonNode node) {
        String position = EspnPlayerFields.position(node);
        ...
        return new FetchedPlayer(
                ...
                fullName,
                position,
                EspnPlayerFields.eligiblePositions(node, position),
                EspnPlayerFields.jerseyNumber(node),
                EspnPlayerFields.teamAbbrev(node),
